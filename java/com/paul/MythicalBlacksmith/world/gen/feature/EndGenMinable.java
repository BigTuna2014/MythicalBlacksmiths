...
public class EndGenMinable extends WorldGenerator
{
    ...
    public EndGenMinable(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.end_stone);
    }

    public EndGenMinable(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
