package com.paul.MythicalBlacksmith.model;
...
public class ModelMinotaur extends ModelBase
{
    ...
    public ModelMinotaur(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelMinotaur(float p_i1162_1_, float p_i1162_2_)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
        EntityMinotaur entityirongolem = (EntityMinotaur)p_78086_1_;
