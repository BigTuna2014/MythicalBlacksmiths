...
public abstract class EntityPercyThrowable extends Entity implements IProjectile
{
    ...
    public EntityPercyThrowable(World p_i1776_1_)
    {
        super(p_i1776_1_);
    ...
    public EntityPercyThrowable(World p_i1777_1_, EntityLivingBase p_i1777_2_)
    {
        super(p_i1777_1_);
    ...
    public EntityPercyThrowable(World p_i1778_1_, double p_i1778_2_, double p_i1778_4_, double p_i1778_6_)
    {
        super(p_i1778_1_);
    ...
    public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_, float p_70186_8_)
    {
        ...
        p_70186_1_ += this.rand.nextGaussian() * 0.107499999832361937D * (double)p_70186_8_;
        p_70186_3_ += this.rand.nextGaussian() * 0.107499999832361937D * (double)p_70186_8_;
        p_70186_5_ += this.rand.nextGaussian() * 0.107499999832361937D * (double)p_70186_8_;
