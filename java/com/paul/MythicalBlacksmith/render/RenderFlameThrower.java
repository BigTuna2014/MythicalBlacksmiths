...
public class RenderFlameThrower extends Render
{
    ...
    public RenderFlameThrower(Item item, int i)
    {
        this.field_94151_a = item;
        this.field_94150_f = i;
    }
 
    public RenderFlameThrower(Item item)
    {
        this(item, 0);
    }
     ...
     */
    public void doRender(EntityFlameThrower p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        float f11 = (float)p_76986_1_.throwableShake - p_76986_9_;
    ...
    private void func_77026_a(Tessellator tess, IIcon p_77026_2_)
    {
    ...
    {
        this.doRender((EntityFlameThrower)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
