...
public class ArtemisBowClass extends Item
{
    public static final String[] bowPullIconNameArray = new String[] {"pulling_0", "pulling_1", "pulling_2"};
    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

    public ArtemisBowClass()
    {
        this.maxStackSize = 1;
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (flag || p_77615_3_.inventory.hasItem(MainClass.ApollosArrow))
        {
           ...
           EntityArtemisArrow entityarrow = new EntityArtemisArrow(p_77615_2_, p_77615_3_, f * 2.0F);
            ...
            {
                p_77615_3_.inventory.consumeInventoryItem(MainClass.ApollosArrow);
            }
    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_)
    {
        ...
        if (p_77659_3_.capabilities.isCreativeMode || p_77659_3_.inventory.hasItem(MainClass.ApollosArrow))
        {
    ...
    public ArtemisBowClass register(String name){
