...
import com.paul.MythicalBlacksmith.util.Damage;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class EntityApollosArrow extends Entity implements IProjectile
{
    ...
    public EntityApollosArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityApollosArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityApollosArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityApollosArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            ticksInGround++;
            worldObj.createExplosion(this, posX, posY, posZ, 3.0F, inGround);
            setDead();
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = Damage.causeApollosArrowDamage(this, this);
                    }
                    else
                    {
                        damagesource = Damage.causeApollosArrowDamage(this, this.shootingEntity);
                    }
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(MainClass.ApollosArrow, 1)))
            {
                flag = false;
            }
