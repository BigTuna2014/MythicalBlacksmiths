...
public class EntityFriendlyAuto extends EntityTameable
{
    ...
    public EntityFriendlyAuto(World p_i1696_1_)
    {
        super(p_i1696_1_);
        ...
        this.tasks.addTask(7, new EntityAIWander(this, 0.0D));
    ...
    else if (itemstack != null && itemstack.getItem() == Items.redstone && !this.isAngry())
        {
            if (!p_70085_1_.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
    ...
    public EntityFriendlyAuto createChild(EntityAgeable entity)
    {
        EntityFriendlyAuto entitywolf = new EntityFriendlyAuto(this.worldObj);
