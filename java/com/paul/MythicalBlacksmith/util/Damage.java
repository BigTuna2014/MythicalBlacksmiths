package com.paul.MythicalBlacksmith.util;
...
public class Damage extends DamageSource
{
	...
	public Damage(String p_i1566_1_) {
		super(p_i1566_1_);
	}
    ...
    public static DamageSource causeApollosArrowDamage(EntityApollosArrow arrow, Entity entity)
    {
        return new EntityDamageSourceIndirect("arrow", arrow, entity).setProjectile();
    }
    
    public static DamageSource causeArtemisArrowDamage(EntityArtemisArrow arrow, Entity entity)
    {
        return new EntityDamageSourceIndirect("arrow", arrow, entity).setProjectile();
    }
    ...
    public void DamageSource(String p_i1566_1_)
    {
