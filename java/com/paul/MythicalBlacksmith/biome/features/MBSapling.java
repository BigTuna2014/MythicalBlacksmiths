...
import com.paul.MythicalBlacksmith.world.gen.feature.*;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class MBSapling extends BlockSapling {
	
	public static final String[] saplings = new String[] {"Olive"};
	    ...
	    public void func_149878_d(World world, int x, int y, int z, Random random)
	    {
	        ...
	        {
	            case 0:
	            	object = new WorldGenOliveTree(flag, j1, j1, j1, flag);
	            	//object = new WorldGenOliveTree(MainClass.blockLog, MainClass.blockLeaf, 0, 0, false, 5, 7, false);
	            	break;
	            case 1:
	                break;
	            case 2:
	    ...
	    public void registerBlockIcons(IIconRegister iconRegister)
	    {
	        ...
	        {
	            iconLength[i] = iconRegister.registerIcon(MainClass.MODID + ":" + this.getUnlocalizedName().substring(5) + saplings[i]);
	        }
	    }
